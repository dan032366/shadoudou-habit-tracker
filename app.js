...
const DAILY_EVAL = {
  full: [
    '全勤！今天所有项目都完成了，太棒了 (ノ◕ヮ◕)ノ',
    '今天完成全部打卡，简直完美 (★≧▽≦)★',
    '满分收工，今天又是元气满满的一天 ＼(^▽^)／'
  ],
  near: [
    '差一点点就全勤，明天继续加油！(ง •̀_•́)ง',
    '完成度很高了，再坚持一下就是满分！(๑•̀ㅂ•́)و',
    '今天表现很棒，离全勤只差一步！(￣▽￣)ノ'
  ],
  half: [
    '完成过半，势头很好，保持住！(•̀ᴗ•́)و',
    '已经完成一半以上，继续加油！ヽ(•̀ω•́)ゝ',
    '今天还不错，再接再厉！(๑•̀ω•́)'
  ],
  low: [
    '今天起步有点慢，没关系，完成一点也是进步！(´•ω•̥`)',
    '万事开头难，先迈出第一步就是胜利！( •̀ω•́ )✧',
    '今天完成得不多，但每一份坚持都算数！(づ｡◕‿‿◕｡)づ'
  ],
  zero: [
    '万事开头难，先从一个小目标开始吧！(´･ω･`)',
    '今天还没开始，别灰心，随时可以出发！(๑•́ ₃ •̀๑)',
    '休息一天也没关系，明天重新出发！(｡•́︿•̀｡)'
  ]
};
...
const MONTH_EVAL = {
  great: [
    '这个月表现太出色了，几乎天天全勤！(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧',
    '坚持得非常好，你就是打卡达人！(๑•̀ㅂ•́)و✧'
  ],
  good: [
    '这个月整体完成度不错，继续保持！(￣▽￣)ノ',
    '稳扎稳打，这个月做得很棒！(•̀ᴗ•́)و'
  ...
  ok: [
    '完成度还有提升空间，坚持就是胜利！(ง •̀_•́)ง',
    '这个月有些起伏，但每一步都算数！(｡•̀ᴗ-)✧'
  ],
  low: [
    '这个月开始得不容易，别灰心，下个月重新出发！(´•ω•̥`)',
    '完成不多也没关系，慢慢来，持续比完美更重要！(๑•́ω•̀)'
  ]
};
